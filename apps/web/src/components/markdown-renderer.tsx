...
export function MarkdownRenderer({ children, className }: MarkdownRendererProps) {
  return (
    <div
      className={cn(
        "text-[12.5px] leading-[1.6] text-vs-fg-3",
        // Block spacing — tighter than `prose` defaults, which read as
        // "article" rather than "email body" at this scale.
        "[&_p]:my-2 [&_p:first-child]:mt-0 [&_p:last-child]:mb-0",
        "[&_h1]:text-[15px] [&_h1]:font-semibold [&_h1]:text-vs-fg-4 [&_h1]:mt-3 [&_h1]:mb-1.5",
        "[&_h2]:text-[14px] [&_h2]:font-semibold [&_h2]:text-vs-fg-4 [&_h2]:mt-3 [&_h2]:mb-1.5",
        "[&_h3]:text-[13px] [&_h3]:font-semibold [&_h3]:text-vs-fg-4 [&_h3]:mt-2.5 [&_h3]:mb-1",
        "[&_h4]:text-[12.5px] [&_h4]:font-semibold [&_h4]:text-vs-fg-4 [&_h4]:mt-2 [&_h4]:mb-1",
        // Inline text
        "[&_strong]:font-semibold [&_strong]:text-vs-fg-4",
        "[&_em]:italic",
        "[&_a]:text-vs-purple-4 [&_a]:underline [&_a]:underline-offset-2 hover:[&_a]:text-vs-purple-3",
        "[&_a]:break-words",
        // Lists
        "[&_ul]:my-2 [&_ul]:pl-4 [&_ul]:list-disc [&_ul]:marker:text-vs-fg-2",
        "[&_ol]:my-2 [&_ol]:pl-4 [&_ol]:list-decimal [&_ol]:marker:text-vs-fg-2",
        ...
        "[&_blockquote]:border-l-2 [&_blockquote]:border-vs-bg-3/60 [&_blockquote]:pl-3",
        "[&_blockquote]:my-2 [&_blockquote]:text-vs-fg-2",
        ...
        "[&_code]:rounded [&_code]:bg-vs-bg-a2 [&_code]:px-1 [&_code]:py-px",
        "[&_code]:font-mono [&_code]:text-[11.5px] [&_code]:text-vs-fg-4",
        ...
        "[&_pre]:my-2 [&_pre]:rounded-md [&_pre]:bg-vs-bg-a2 [&_pre]:p-2",
        ...
        "[&_th]:border [&_th]:border-vs-bg-3/40 [&_th]:px-1.5 [&_th]:py-1 [&_th]:font-medium [&_th]:text-vs-fg-4",
        "[&_td]:border [&_td]:border-vs-bg-3/40 [&_td]:px-1.5 [&_td]:py-1",
        "[&_td]:break-words [&_th]:break-words",
        // Horizontal rule
        "[&_hr]:my-3 [&_hr]:border-t [&_hr]:border-vs-bg-3/60",
