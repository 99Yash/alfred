...
export function AccessNotice({ className }: { className?: string }) {
  return (
    <section id="access" className={cn("relative w-full scroll-mt-24 py-16 sm:py-20", className)}>
            ...
            <div className="flex flex-col gap-5 sm:flex-row sm:gap-6">
              ...
              <div className="flex flex-col gap-3">
                ...
                <p className="text-[14.5px] leading-[1.6] text-pretty text-neutral-400 sm:text-[15px]">
                  To work across your inbox, Alfred reads your email through the same restricted
                  Gmail scopes Google reserves for serious products. The verified badge for those
                  scopes takes a CASA security audit, billed{" "}
                  <em className="text-neutral-300 not-italic">every single year</em>. Hard to
                  justify for a project of one. So Google greets you with an “unverified app” screen
                  on the way in. The access is real. Only the badge is missing.
                </p>

                <p className="text-[14.5px] leading-[1.6] text-pretty text-neutral-400 sm:text-[15px]">
                  Two ways in. Email me for a seat on the allowlist. Or skip the wait; Alfred is
                  open source. Clone it, bring your own keys, or roll your own.
                </p>
