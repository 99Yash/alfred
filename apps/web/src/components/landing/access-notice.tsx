...
export function AccessNotice({ className }: { className?: string }) {
  return (
    <section
      id="access"
      className={cn(
        'relative mx-auto w-full max-w-3xl scroll-mt-24',
        className,
      )}
    >
      <FadeInOnScroll>
        ...
        >
          <div className="flex flex-col gap-5 sm:flex-row sm:gap-6">
            ...
            <div className="flex flex-col gap-3">
              ...
              <p className="text-pretty text-[14.5px] leading-[1.6] text-neutral-400 sm:text-[15px]">
                Two ways in. Email me for a seat on the allowlist. Or skip the
                wait; Alfred is open source. Clone it, bring your own keys, or
                roll your own.
              </p>
