  ...
  return (
    <div className="hidden lg:flex relative items-center justify-center overflow-hidden border-l border-app-bg-a1">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(60% 60% at 70% 35%, color-mix(in oklch, var(--app-purple-4) 14%, transparent), transparent 70%)",
        }}
      />
      ...
      <div className="relative z-10 max-w-[420px] px-10 py-12 space-y-7">
        ...
        <div className="relative">
          ...
          <div
            aria-hidden
            className={cn(
              "absolute inset-x-3 top-3 bottom-[-12px] rounded-2xl bg-app-bg-1",
