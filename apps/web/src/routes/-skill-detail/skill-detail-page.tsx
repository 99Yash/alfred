...
import { findSkillFixture } from "~/lib/skills";
...
export function SkillDetailPage() {
  ...
  const skill = findSkillFixture(slug);
    ...
    return (
      <DetailShell>
        ...
        <AppCard className="flex flex-col items-center gap-2 px-6 py-12 text-center">
          <p className="text-sm font-medium text-app-fg-4">SkillFixture not found</p>
  ...
  return (
    <DetailShell>
      ...
      <AppSegmented<DetailTab>
        ...
        label="SkillFixture detail sections"
      />
