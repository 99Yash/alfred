...
export function WeatherHero() {
  ...
  return (
    ...
    >
      ...
      <div
        className="animate-rail-head mt-2.5 min-w-0 truncate text-[12.5px] leading-none tracking-tight text-white/60 mix-blend-plus-lighter [animation-delay:150ms]"
        title={caption}
      >
        {caption}
      </div>
