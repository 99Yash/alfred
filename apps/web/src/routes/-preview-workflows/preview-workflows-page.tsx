      ...
      <main className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        ...
        <section className="mt-12 space-y-3">
          ...
          {builtins.length > 0 ? (
            ...
            <p className="px-1 text-xs text-app-fg-3">
        ...
        <section className="mt-12 space-y-3">
          ...
          {authored.length > 0 ? (
            ...
            <AppCard
              padded={false}
              className="app-card-in flex flex-col items-center justify-center gap-2 px-6 py-12 text-center"
              style={{ animationDelay: `${builtins.length * 70 + 80}ms` }}
            >
              <span
                className="inline-flex size-9 items-center justify-center rounded-full border border-app-bg-3 text-app-fg-3"
                aria-hidden
              >
                <Sparkles size={16} />
              </span>
