 ...
 * `node dist/scripts/backfill-gmail-sent-committed.js` — the prod image has no
 ...
 *   node dist/scripts/backfill-gmail-sent-committed.js --emails=yashgouravkar@gmail.com
 *   # commit, last 365d of sent mail:
 *   node dist/scripts/backfill-gmail-sent-committed.js --emails=yashgouravkar@gmail.com --newer-than=365d --commit
 *   # every connected Google account, full custom query:
 *   node dist/scripts/backfill-gmail-sent-committed.js --all-connected --query="in:sent" --commit
 */
