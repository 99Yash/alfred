 ...
 * `node dist/scripts/backfill-object-state-github-committed.js` — the prod
 ...
 *   node dist/scripts/backfill-object-state-github-committed.js
 *   # commit:
 *   node dist/scripts/backfill-object-state-github-committed.js --commit
 */
import { closeConnections, closeRedis, objectStateStore, warmPool } from "@alfred/api";
