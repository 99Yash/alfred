 ...
 *   $ RAILWAY_TOKEN=xxxx pnpm --filter server tsx src/scripts/probes/probe-railway-token.ts
 *   # or:
 *   $ pnpm --filter server tsx src/scripts/probes/probe-railway-token.ts <token>
 *
