 ...
 * with plain `node dist/scripts/trigger-cold-start-committed.js` — the prod
 ...
 *   node dist/scripts/trigger-cold-start-committed.js
 *   # commit:
 *   node dist/scripts/trigger-cold-start-committed.js --commit
 *   # override target(s):
 *   COLD_START_EMAILS="a@x.com,b@y.com" node dist/scripts/trigger-cold-start-committed.js --commit
 */
import {
  closeAgentQueue,
  closeConnections,
