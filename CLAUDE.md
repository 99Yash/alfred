...
- When opening a PR, state the issues it closes in the body with GitHub closing keywords (`Closes #N`), one per issue the PR _fully_ resolves. Reference a partially-addressed issue (e.g. `Refs #N`) without a closing keyword.
