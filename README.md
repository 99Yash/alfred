...
corepack pnpm verify          # verify:fast plus every workspace test suite (much slower)
corepack pnpm verify:db       # migrate and run the Postgres/Redis-backed suites of every workspace
