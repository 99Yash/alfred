...
// Measured 2026-09-17: full 93,131 → 94,411 B across 77 tools — the standing-instruction
// `scope` field (#1107) adds one optional enum to `system.remember`, at the top level and on
// each `senders` entry, plus the two lines of tool prose that steer the domain option. NO
// ceiling bump: 94,411 B still sits under 95,000 B, and the ~589 B of margin left is the
// intended tightness — the next tool addition trips the ceiling and records its own line.
