...
export const fetchChatThreads = syncEntity<"CHAT_THREAD", ChatThread>("CHAT_THREAD", {
  query: (tx, userId) =>
    tx
      .select()
      .from(chatThreads)
...
export const fetchChatMessages = syncEntity<"CHAT_MESSAGE", ChatMessage>("CHAT_MESSAGE", {
  query: (tx, userId) =>
    tx
      .select()
      .from(chatMessages)
...
export const fetchChatAttachments = syncEntity<"CHAT_ATTACHMENT", ChatAttachment>(
  "CHAT_ATTACHMENT",
  {
