...
function buildArtifactDesignPrompt(): string {
  ...
  return [
    ...
    [
      ...
      "- Structure: wrap the page in `art-doc`. Then art-doc-header (name and role on the left, art-doc-contact stack on the right), art-doc-lede (a one-line summary), art-doc-section (a label), art-doc-entry containing art-doc-entry-head (art-doc-entry-title with a muted `<span>` for the org, plus art-doc-entry-meta for the date) and art-doc-entry-desc. Use art-doc-cols for a two-column footer, art-doc-chips + art-doc-chip for skills or tags, and art-doc-rule for a section separator.",
      "- Let the document flow top to bottom with even, generous spacing between sections. Thin content should breathe rather than pile up at the top; trailing whitespace at the bottom is fine. Do not force a footer to the page bottom with a spacer, which strands a gap in the middle.",
    ].join("\n"),
