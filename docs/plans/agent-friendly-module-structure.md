...
| `context-search`  | Cross-integration read boundary: registered read-only evidence sources, the query/task envelope, and bounded source-attributed results (epic #422) | `searchContext`, `registerContextSource`, `registerDefaultContextSources`, `listContextSources`, `ContextSearchRequest`, `ContextSource`; adapters, the source registry internals, and the deterministic ranker (#427) stay private                                                                                                                                                                                                                                 | new (#422)                                                                                |
