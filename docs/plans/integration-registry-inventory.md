...
| `chatConnectNudge.integration` is `z.string()` (section 6, item 7) | Open. It is a persisted payload. Tighten it with the registry PR. |
| The registry design (sections 7 to 9) | Not started. Section 9 needs a decision first. |
