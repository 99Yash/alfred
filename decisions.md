...
## ADR-0068 — High-`riskTier` tools always confirm: a hard approval floor the autonomy toggle cannot override (reverses ADR-0034 alt-(f); supersedes ADR-0050's "no structural risk gate")
