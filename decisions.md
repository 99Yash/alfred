...
## ADR-0075 — Produce-artifact capability: the agent generates artifacts (PDF/slides/sheets/docs) and renders them inline, agent-authored not Google-exported (FRAMED — DEFERRED, not designed)
