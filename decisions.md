...
| [0088](./docs/decisions/ADR-0088-the-mcp-call-approval-floor-is-a-floor-not-a.md) | Dynamic tool risk resolves at the dispatch gate: reviewed MCP downgrades require an audited declaration, undeclared downgrades clamp to the static tier, and Calendar invites raise `medium` to `high` (BUILT — #541 Part 3, amended by #232; amends ADR-0069) |
